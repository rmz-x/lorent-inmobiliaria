...
<div class="card" style="max-width:520px">
    ...
    <div style="display:flex;align-items:center;gap:16px;margin-bottom:24px">
        ...
        <div>
            <p style="font-size:18px;font-weight:600;color:#1a3a6b">
                {{ $usuario->nombre }}
            </p>

            <p style="font-size:13px;color:#6c757d;margin-top:3px">
                {{ ucfirst($usuario->rol) }} — {{ $usuario->correo }}
            </p>
            ...
            <div style="margin-top:8px">
                <span
                    style="
                        ...
                        font-weight:600;
                        color:white;
                        background:{{ strtolower($usuario->estado) == 'activo' ? '#22c55e' : '#ef4444' }};
                    "
                >
    ...
    <form method="POST" action="{{ route('perfil.update') }}">
        ...
        <p style="font-size:13px;font-weight:600;color:#1a3a6b;margin-bottom:14px">
            Datos personales
        </p>
        ...
        <div style="display:flex;flex-direction:column;gap:5px;margin-bottom:14px">
            ...
            >
                <option value="activo"
                    {{ strtolower($usuario->estado) == 'activo' ? 'selected' : '' }}>
                    Activo
                </option>

                <option value="inactivo"
                    {{ strtolower($usuario->estado) == 'inactivo' ? 'selected' : '' }}>
                    Inactivo
                </option>
            </select>
